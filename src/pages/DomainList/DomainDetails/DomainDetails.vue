...
import type { DomainDetails } from '../../../types/domain'
    ...
    <template v-else>
      ...
      <v-row>
        <v-col class="d-flex flex-column ga-6" :lg="8" :md="12" :sm="12">
          ...
          <DomainStateFlagsCardVerbose v-if="verbose" :flags="domainDetails.state_flags" />
          <DomainStateFlagsCard v-else :flags="domainDetails.state_flags.flags" />
        </v-col>
        <v-col class="d-flex flex-column ga-6" :lg="4" :md="12" :sm="12">
          ...
          <DomainContactsCard v-else :contacts="domainDetails.administrative_contacts" />
